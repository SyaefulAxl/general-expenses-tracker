...
const STORAGE_KEY = 'gen_expenses_store_v1';
...
const SEED_EXPENSES: Expense[] = [
  ...
  { id: 1022, expenseDate: '2026-05-09', amount:  63.25,description: 'Chicken Upper Wings',        toko: 'Makro',    source: 'Winda Cash', category: 'Food',      recorderId: 2, shared: false, status: 'APPROVED', createdAt: '2026-05-09T18:00:00Z' },
...
export class MockDataService {
  ...
  resetToSeed(): void {
    this._expenses.set([...SEED_EXPENSES]);
  ...
  private loadFromStorage(): void {
    try {
      ...
      if (raw) {
        ...
        this._expenses.set(parsed.expenses ?? [...SEED_EXPENSES]);
